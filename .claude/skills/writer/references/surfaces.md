...
| Monthly users | 50M+ |
| Akamai TTFB | <300ms, global |
| Edge cache hit rate | 98.4% |
| Production years | 9+ |
| Org | 20 engineers, 3 web teams, CNBC Web & Make It (Versant) |
| CNBC.com business | $50–55M ARR, 170K+ subscribers |
| AI assistant | 200-subscriber beta cohort — a pilot, **not** a site-wide surface |
| AI governance outcome | 25% velocity increase, 15% fewer high-severity defects |
