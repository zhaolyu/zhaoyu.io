...
const DENY_LIST: Array<{ pattern: RegExp; why: string }> = [
  ...
  { pattern: /[redacted]/, why: 'subscriber count is not publicly disclosed' },
  {
    pattern: /[redacted]|200 subscribers|200 Subs/i,
  ...
  {
    pattern: /rotat(e|ing) through|[redacted]/i,
    why: 'publicly criticises internal staffing',
  },
  { pattern: /[redacted]|[redacted]/i, why: 'unannounced video roadmap' },
  { pattern: /[redacted]|[redacted]/i, why: 'unannounced AI product internals' },
  { pattern: /[redacted]|[redacted]/i, why: 'internal governance metrics' },
  { pattern: /50M\+?/, why: 'the public ComScore figure is 47M (Versant Investor Day 2025)' },
  { pattern: /[redacted]/i, why: 'contradicted by public CrUX data (origin fails CWV on CLS)' },
