...
export const performanceMetrics: PerformanceMetric[] = [
  ...
  { label: 'Premium Subscribers', value: '[redacted]', sublabel: 'CNBC PRO Platform' },
  { label: 'Platform Revenue', value: '[redacted]–55M', sublabel: 'ARR · CNBC PRO' },
...
export const builderProjects: BuilderProject[] = [
  {
    ...
    description:
      "Co-leading 20 engineers to architect CNBC.com's next-generation Micro-Frontend platform from scratch — the technical foundation for [redacted] premium subscribers generating [redacted]–55M ARR. Architecting for composability, independent deployability, and subscriber growth through 2027.",
    stack: ['Micro-Frontend', 'TypeScript', 'React', 'Node.js'],
    status: 'in-progress',
    metrics: [
      { label: 'Engineers', value: '20+' },
      { label: 'ARR', value: '[redacted]–55M' },
    ],
  },
  {
    title: 'CNBC Financial Assistant',
    category: 'professional',
    description:
      "Sole frontend engineer and product bridge for CNBC's first user-facing AI product. Built the entire UI and spec'd the multi-step agentic pipeline (MCP) with the backend team. Shipped in four months — currently in beta with 200 subscribers, scaling to [redacted].",
