  ...
  notes: [
    ...
    },
    {
      ...
      sources: [
        {
          label:
            'First-hand: OB1, a personal exocortex — 1,700 claims and 8,281 wiki-links, measured 30 Aug 2026',
        },
      ],
      content: [
        ...
        'So OB1 stores judgment the way it has to be retrieved. A claim is one assertable proposition, named by a filename that states it in full, hand-typed as claim, pattern, tension, or anti-pattern — <strong>nothing derives that type, which is precisely why it carries judgment</strong>: a thing is an anti-pattern because someone decided it was. Retrieval embeds the query, ranks with pgvector, then expands one hop along the wiki-links, so a claim reached by a <code>parallels</code> edge surfaces even when its own similarity is low; 2,777 of the 8,281 edges cross domains, and those are the ones worth the hop. MCP exposes it to every agent session. On 15 August a reduce pass was about to generalize a second claim about legibility inverting felt value — retrieval returned <code>prevented-loss-invisibility</code>, already established on a named external source, and the output became an enrichment instead of a duplicate. <strong>The judgment you have to remember to look up is judgment you do not have.</strong>',
      ],
    },
    {
