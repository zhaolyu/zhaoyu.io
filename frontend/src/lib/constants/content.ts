...
export const heroContent: HeroContent = {
  ...
  bio: 'Principal Engineer at CNBC. Leading the migration to Isomorphic Akamai Edge Architecture for [redacted] monthly users. Architecting high-scale systems that achieve [redacted] through performance-first engineering and governed AI integration.',
  cta: {
