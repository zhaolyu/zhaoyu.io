  ...
  notes: [
    ...
    },
    {
      ...
      sources: [
        {
          label:
            'First-hand: reviewing delegated agent output while co-leading a rebuild across 3 teams',
        },
      ],
      content: [
