...
describe('getRelativeTime', () => {
    ...
    const pluralizationTests = [
      {
        ...
        singular: {
          ...
          shouldNotContain: 'minutes',
        },
        plural: {
          date: '2024-01-15T11:58:00',
          expected: '2 minutes ago',
          shouldContain: 'minutes',
        },
      },
      {
        unit: 'hour',
  ...
  describe('Boundary conditions', () => {
    ...
    boundaryTests.forEach(
      ({ name, date, shouldContain, shouldNotContain, description: _description }) => {
