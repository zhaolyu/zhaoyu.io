    ...
    <div class="card-content">
      <div class="content-inner">
        ...
        {#if diagram === 'ai-state-machine'}
          <p class="card-role">Principal Engineer & Product Bridge</p>
        {/if}
        ...
        {#if diagram === 'ai-state-machine'}
          <div class="pipeline-block">
            <h4 class="pipeline-title">Agentic Pipeline Architecture</h4>
            <div class="pipeline-flow">
              <span class="pipeline-step">User Query</span>
              <span class="pipeline-arrow">→</span>
              <span class="pipeline-step">Tool Planner</span>
              <span class="pipeline-arrow">→</span>
              <span class="pipeline-step pipeline-step-active">MCP Retrieval</span>
              <span class="pipeline-arrow">→</span>
              <span class="pipeline-step">Tool Grader</span>
              <span class="pipeline-arrow">→</span>
              <span class="pipeline-step">Response Gen</span>
            </div>
          </div>

          <ul class="impact-list">
            <li>
              <strong>Multi-Surface Orchestration:</strong> Translated product requirements into architectural decisions across both frontend UI and backend LLM surfaces, ensuring a deterministic UX from non-deterministic outputs.
            </li>
            <li>
              <strong>MCP Integration:</strong> Leveraged the Model Context Protocol to ground the AI in real-time proprietary financial data — bypassing standard RAG limitations.
            </li>
            <li>
              <strong>Scale & Velocity:</strong> Shipped zero-to-beta in four months. Currently active with 200 beta users, hardened to scale to [redacted] premium subscribers.
            </li>
          </ul>
        {/if}
...
<style>
  ...
  /* ── AI card: pipeline architecture block ── */
  .pipeline-block {
    --pl-bg: rgba(0, 0, 0, 0.025);
    --pl-border: rgba(0, 0, 0, 0.07);
    --pl-title: rgba(0, 0, 0, 0.32);
    --pl-step-bg: rgba(0, 0, 0, 0.035);
    --pl-step-border: rgba(0, 0, 0, 0.09);
    --pl-step-color: rgba(0, 0, 0, 0.48);
    --pl-arrow: rgba(0, 0, 0, 0.22);
  ...
  :global(.dark) .pipeline-block {
    --pl-bg: rgba(255, 255, 255, 0.03);
    --pl-border: rgba(255, 255, 255, 0.07);
    --pl-title: rgba(255, 255, 255, 0.28);
    --pl-step-bg: rgba(255, 255, 255, 0.04);
    --pl-step-border: rgba(255, 255, 255, 0.08);
    --pl-step-color: rgba(255, 255, 255, 0.45);
    --pl-arrow: rgba(255, 255, 255, 0.2);
  }
  ...
  .pipeline-step {
    ...
    font-family: var(--font-mono);
    padding: 0.25rem 0.5rem;
    background: var(--pl-step-bg);
    color: var(--pl-step-color);
    border: 1px solid var(--pl-step-border);
    border-radius: 0.25rem;
    white-space: nowrap;
    transition:
      background-color 0.2s,
  ...
  .pipeline-step-active {
    ...
    box-shadow: 0 0 8px var(--accent-primary-10);
    transition:
      background-color 0.2s,
      color 0.2s,
      border-color 0.2s,
