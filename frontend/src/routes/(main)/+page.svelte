...
<svelte:head>
  <title>Zhao Yu | Senior Manager, Engineering at Versant (CNBC Web &amp; Make It)</title>
  ...
  <meta
    property="og:title"
    content="Zhao Yu — Senior Manager, Engineering at Versant (CNBC Web &amp; Make It). Player-coach engineering leader."
  />
  ...
  <meta
    ...
    content="Zhao Yu — Senior Manager, Engineering at Versant (CNBC Web &amp; Make It)"
  />
  ...
  <script type="application/ld+json">
    {
      ...
      "worksFor": {
        "@type": "Organization",
        "name": "Versant Media / CNBC"
      },
      "description": "Senior Manager, Engineering across the CNBC Web and Make It divisions, directing a 20-engineer organization across 3 web teams executing the platform rebuild of CNBC.com ($50-55M ARR, 170K+ subscribers) while staying hands-on in core architecture. Sole frontend architect of CNBC's AI financial assistant, shipped to a 200-subscriber beta pilot, and AI Integration Lead for org-wide AI governance standards. Nine years of performance-first engineering: isomorphic Akamai edge systems for 50M+ monthly users at a 1.1s LCP and zero-downtime infrastructure migrations.",
      "knowsAbout": [
