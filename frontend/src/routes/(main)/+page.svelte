...
<svelte:head>
  ...
  <meta
    name="description"
    content="Principal Engineer at CNBC architecting high-performance media systems for [redacted] users. AI Integration Lead and independent builder shipping production-grade systems."
  />
  ...
  <meta
    ...
    content="Principal Engineer at CNBC. [redacted], [redacted] users, AI Integration Lead, independent builder. Opinionated on latency, streaming interfaces, and production AI."
  />
  ...
  <script type="application/ld+json">
    {
      ...
      "description": "Principal Engineer at CNBC architecting high-performance isomorphic edge systems for [redacted] monthly users. AI Integration Lead and independent builder.",
      "knowsAbout": [
        "Edge Computing",
        "Akamai EdgeWorkers",
        "Isomorphic React",
