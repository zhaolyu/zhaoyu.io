<script lang="ts">
  ...
  const principles = [
    ...
    },
    {
      ...
      body: 'Non-deterministic output demands a deterministic, accessible interface as its stability layer. The UI is a contract, not a display — that is what makes streaming AI trustworthy enough for [redacted] monthly users on a financial news platform.',
    },
    {
      num: '05',
