...
This directory contains documentation for the SvelteKit frontend implementation.
...
- **Cursor AI Rules**: See `.cursor/docs/` for coding patterns, conventions, and development workflow
- **Main Project Docs**: See `../../docs/` for project-level documentation (GitHub auth, deployment recommendations, etc.)

## Quick Links

- [Frontend README](../README.md) - Quick start and overview
- [Main Project README](../../README.md) - Project overview and Git configuration
